...
<head>
    ...
    <title>تأكيد الحجز | منصة أمان</title>
    <style>
        .popup{
                ...
                <tr >
                    ...
                    <td >
                        <form action="schedule.php" method="post" class="header-search">
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="ابحث عن اسم المزود أو التاريخ" list="doctors" >&nbsp;&nbsp;
                            <?php
                            ...
                            if(($_GET)){
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            اسم المزود:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            البريد الإلكتروني:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        <div class="h3-search" style="font-size:18px;">
                                                        </div><br>
                                                        <div class="h3-search" style="font-size:18px;">
                                                            عنوان الجلسة: '.$title.'<br>
                                                            تاريخ الجلسة: '.$scheduledate.'<br>
                                                            وقت البداية: '.$scheduletime.'<br>
                                                            رسوم الخدمة: <b>مجانية (النسخة التجريبية)</b>
                                                        </div>
                                                        <br>
                                                </div>
                                            </div>
                                        ...
                                        <td style="width: 25%;">
                                            <div  class="dashboard-items search-items"  >
                                                <div style="width:100%;padding-top: 15px;padding-bottom: 15px;">
                                                        <div class="h1-search" style="font-size:20px;line-height: 35px;margin-right:8px;text-align:center;">
                                                            رقم موعدك المتوقع
                                                        </div>
                                                        <center>
                                                        <div class=" dashboard-icons" style="margin-right: 0px;width:90%;font-size:70px;font-weight:800;text-align:center;color:#059669;background-color: #f0fdf4">'.$apponum.'</div>
                                                    </center>
                                                        </div><br>
                                                        <br>
                                                        <br>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-right:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="احجز الآن" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
